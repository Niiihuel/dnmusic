...
select pg_temp.update_denied($q$select public.admin_save_update_policy('windows','1.12.0','0.0.0','https://github.com/Niihuel/dnmusic-releases/releases/latest',true,0)$q$);
...
select pg_temp.update_check(public.admin_save_update_policy('windows','1.12.0','0.0.0','https://github.com/Niihuel/dnmusic-releases/releases/latest',true,0)->>'revision'='1','owner can publish optional');
select pg_temp.update_check(public.admin_save_update_policy('windows','1.13.0','1.12.0','https://github.com/Niihuel/dnmusic-releases/releases/tag/v1.13.0',true,1)->>'minimum_version'='1.12.0','owner decides minimum in rolled-back fixture');
select pg_temp.update_check(jsonb_array_length(public.admin_update_policies())=1,'list confirms persisted policy');
select pg_temp.update_denied($q$select public.admin_save_update_policy('windows','1.13.0','0.0.0','https://github.com/Niihuel/dnmusic-releases/releases/latest',true,0)$q$,'40001');
select pg_temp.update_denied($q$select public.admin_save_update_policy('windows','1.13.0','0.0.0','https://github.com/Niihuel/dnmusic-releases/releases/latest',true,1)$q$,'40001');
select pg_temp.update_denied($q$select public.admin_save_update_policy('windows','1.13.0','1.14.0','https://github.com/Niihuel/dnmusic-releases/releases/latest',true,2)$q$,'23514');
select pg_temp.update_denied($q$select public.admin_save_update_policy('windows','1.13.0-beta','0.0.0','https://github.com/Niihuel/dnmusic-releases/releases/latest',true,2)$q$,'22023');
select pg_temp.update_denied($q$select public.admin_save_update_policy('windows','01.13.0','0.0.0','https://github.com/Niihuel/dnmusic-releases/releases/latest',true,2)$q$,'22023');
...
select pg_temp.update_denied($q$select public.admin_save_update_policy('windows','1.13.0','0.0.0','https://github.com@evil.test/Niihuel/dnmusic-releases/releases/latest',true,2)$q$,'23514');
select pg_temp.update_denied($q$select public.admin_save_update_policy('other','1.13.0','0.0.0','https://github.com/Niihuel/dnmusic-releases/releases/latest',true,0)$q$,'23514');
...
select pg_temp.update_check(public.admin_save_update_policy('windows','1.13.0','0.0.0','https://github.com/Niihuel/dnmusic-releases/releases/latest',false,2)->>'enabled'='false','owner can revoke mandatory policy');
