...
function fixture() {
  ...
  new Function('exports', 'require', output)(exports, id => {
    ...
    if (id === 'react-native') return { ...generic(id), View:'View', Pressable:'Pressable', Text:'Text', FlatList:'FlatList', ScrollView:'ScrollView', StyleSheet:{ create:v=>v }, Platform:{OS:'web'} }
