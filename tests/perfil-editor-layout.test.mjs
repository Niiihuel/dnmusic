...
function fixture(nombre = 'Escritorio') {
  ...
  vm.runInNewContext(code, {
    exports, require: () => ({ jsx, jsxs: jsx }), LATERAL_W: 210, MAX_W: 640,
    ...
    ...Object.fromEntries(['Shell', 'SafeAreaView', 'View', 'Panel', 'CabeceraLateral', 'BotonLateral', 'ScrollView', 'Text', 'Pressable', 'CollapsedSidebar', 'PreviaPlegable', 'IconUser', 'IconEye', 'IconEyeOff', 'IconCollapseLeft', 'IconCollapseRight', 'IconBack'].map(n => [n, n])),
  ...
  return { render, width, control, previa, vueltas: () => vueltas }
}
