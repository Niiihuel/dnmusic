  ...
  return (
    <Hoja medida="contenido">
      ...
      >
        ...
        {/* Dos por fila: el marco desborda a la foto y necesita aire alrededor
            — tres por fila los superponía entre sí. */}
        <View className="flex-row flex-wrap justify-center gap-3">
          ...
          >
            <View className="h-[72px] w-[72px] items-center justify-center rounded-full bg-muted">
          ...
          {MARCOS.map((m) => (
            ...
            >
              <View>
                <Avatar name={nombre} path={perfil?.avatarPath} size={72} />
                <Marco marco={m.id} size={72} />
              </View>
            </Opcion>
          ))}
        </View>
...
function Opcion({
  ...
  return (
    <Pressable
      ...
      onPress={onPress}
      className={`w-[136px] items-center gap-3 rounded-2xl px-3 pb-3 pt-5 active:opacity-80 ${
