...
import { FilaAccion, FilaInterruptor, FilaOpciones, GrupoAjustes, ListaAjustes } from '../../src/ui/Ajustes'
import { SeekBar } from '../../src/ui/SeekBar'
import { ICON_COLOR, IconSliders } from '../../src/ui/icons'
import { FRECUENCIAS_EQ, GANANCIA_EQ_MAX, GANANCIA_EQ_MIN, PRESETS_EQ, elegirPresetEcualizador, restablecerEcualizador, setEcualizadorActivo, setGananciaEcualizador, useEcualizador, type PresetEcualizador } from '../../src/state/ecualizador'
